...
const InfromDetail = (resolve) => {
  import('components/inform/detail').then((module) => {
    resolve(module)
  })
}
...
const PhotoMain = (resolve) => {
  import('components/photo/main').then((module) => {
    resolve(module)
  })
}
const PhotoEdit = (resolve) => {
  import('components/photo/edit').then((module) => {
    resolve(module)
  })
}
